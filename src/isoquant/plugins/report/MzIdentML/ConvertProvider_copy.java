 ...
 * @since 12/03/13
 */
public abstract class ConvertProvider_copy<T, V> {
    protected T source;
    protected V params;
     ...
     * V is a object store parameter(s) which maybe used in processing data source.
     */
    public ConvertProvider_copy(T source, V params) {
        this.source = source;
        this.params = params;
    ...
    /**
     * @return {@link uk.ac.ebi.pride.jmztab.model.MZTabFile} model.
     */
    ...
    /**
     * Generate {@link uk.ac.ebi.pride.jmztab.model.MZTabColumnFactory} which maintain a couple of {@link uk.ac.ebi.pride.jmztab.model.PeptideColumn}
     */
    ...
    /**
     * Generate {@link uk.ac.ebi.pride.jmztab.model.MZTabColumnFactory} which maintain a couple of {@link uk.ac.ebi.pride.jmztab.model.SmallMoleculeColumn}
     */
