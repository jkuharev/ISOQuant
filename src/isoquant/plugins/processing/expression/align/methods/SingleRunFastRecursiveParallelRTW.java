...
/**
 * <h3>{@link SingleRunFastRecursiveParallelRTW}</h3>
 * @author Joerg Kuharev
 * @version 12.05.2011 12:35:03
 */
public class SingleRunFastRecursiveParallelRTW extends SingleRunIterativeAlignment
{
	/**
	 * @param context the alignment context
	 */
	public SingleRunFastRecursiveParallelRTW(AlignmentContext context)
	{
		super(context);
	}
