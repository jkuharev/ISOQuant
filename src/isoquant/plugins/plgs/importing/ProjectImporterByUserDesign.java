...
/**
 * <h3>{@link ProjectImporterByUserDesign}</h3>
 * @author Joerg Kuharev
 * @version 12.04.2011 16:17:16
 */
public class ProjectImporterByUserDesign extends SingleActionPlugin4FS implements iProjectImportingPlugin
{
	...
	public ProjectImporterByUserDesign(iMainApp app)
	{
		super(app);
		initDlg();
	}

	@Override public String getMenuItemIconName(){return "design_project";}
	@Override public String getMenuItemText(){return "design analysis and import data";}
	@Override public int getExecutionOrder(){return 1;}
	@Override public String getPluginName(){return "ISOQuant DBProject Importer by User Design";}
	...
	private void runSelection()
	{
		...
		for(int i=0; i<originalProjects.size(); i++)
		{
			try
			{
				...
				// p.db = app.getProjectManager().getNextSchemaNameForPrefix( p.id + "_IQ" );
